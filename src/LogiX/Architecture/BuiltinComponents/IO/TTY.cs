...
// {
//     [NodeDescriptionProperty("Label", StringHint = "e.g. MAIN_TTY", StringMaxLength = 16, StringRegexFilter = "^[a-zA-Z0-9_]*$")]
//     public string Label { get; set; }

//     [NodeDescriptionProperty("Columns", IntMinValue = 1, IntMaxValue = 256, HelpTooltip = "The number of columns in the terminal.")]
//     public int Width { get; set; }

//     [NodeDescriptionProperty("Rows", IntMinValue = 1, IntMaxValue = 256, HelpTooltip = "The number of rows in the terminal.")]
