...
// public class DiskData : INodeDescriptionData
// {
//     [NodeDescriptionProperty("Label", StringHint = "e.g. MAIN_DISK", StringMaxLength = 16, StringRegexFilter = "^[a-zA-Z0-9_]*$")]
//     public string Label { get; set; }

//     [NodeDescriptionProperty("Size", IntMinValue = 1, IntMaxValue = 32)]
//     public int BlockSize { get; set; } // How big a single block is in bytes

//     [NodeDescriptionProperty("Block Address Bits", IntMinValue = 1, IntMaxValue = 32)]
...
// [ScriptType("DISK"), NodeInfo("Disk", "Input/Output", "core.markdown.disk")]
