...
public class RAMContextExtension : INodeContextExtension
{
    ...
    public string MenuItemName => "Assemble from D1Assembly";

    public void Execute(Editor editor, Node node)
    {
        var fileDialog = new FileDialog(FileDialog.LastDirectory, "Select D1Assembly file", FileDialogType.SelectFile, (path) =>
        {
            ...
            using (StreamReader sr = new StreamReader(path))
            {
                ...
                editor.SetMessage(editor.TimedMessages(("Assembled D1Assembly file!", 3000), ("", 0)));
            }
        });
